...
import com.idat.ecdanielmeza.service.MallaCurricularService;
...
public class MallaCurricularController {
	...
	public ResponseEntity<Void> eliminar( @PathVariable Integer id  ) {
		...
		MallaCurricular p = service.obtenerMallaCurricularId(id);
	...
	public ResponseEntity<Void> actualizar( @RequestBody MallaCurricular mallaCurricular ) {
		...
		MallaCurricular p = service.obtenerMallaCurricularId(mallaCurricular.getIdMalla());
